...
$exe = 'C:\Users\Administrator\Desktop\DeepseekHarnessWork\对战平台\client\XiangqiClient\bin\Debug\net9.0-windows\对战平台.exe'
...
if (-not (Wait-ButtonLike $win '创建房间' 20)) { Write-Host 'FAIL: register failed'; exit 1 }
...
$loginBtn = Wait-ButtonLike $win2 '提交登录' 10
