...
class Logger {
  ...
  _openStream() {
    ...
    this.stream.on('error', (err) => console.error('[log] 日志文件写入错误:', err.message));
    this.currentDate = date;
  }

  _write(level, module, msg, extra) {
    ...
    try {
      ...
      console.error('[log] 写入失败:', err.message);
    }
  }

  debug(module, msg, extra) { this._write('DEBUG', module, msg, extra); }
  info(module, msg, extra) { this._write('INFO', module, msg, extra); }
  warn(module, msg, extra) { this._write('WARN', module, msg, extra); }
  error(module, msg, extra) { this._write('ERROR', module, msg, extra); }
